    ...
    <div className="flex h-full min-h-screen">
      ...
      >
        ...
        <div className="flex items-center gap-3 px-4 py-5 shrink-0"
          ...
          <div className="w-9 h-9 rounded-xl flex items-center justify-center shrink-0" style={{ background: "linear-gradient(135deg, #0D5230, #2EB374)" }} aria-hidden="true"><span className="text-white font-bold text-sm">HS</span></div>
          {!collapsed && (
            <div>
      ...
      <div className="flex-1 min-w-0 flex flex-col">
        ...
        >
          {meta.back ? (
            ...
            <div className="w-8 h-8 rounded-lg flex items-center justify-center shrink-0" style={{ background: "linear-gradient(135deg, #0D5230, #2EB374)" }}><span className="text-white font-bold text-xs">HS</span></div>
          )}
