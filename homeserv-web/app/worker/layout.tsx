...
import { LayoutDashboard, ClipboardList, CalendarCheck, TrendingUp, User, ChevronLeft, ChevronRight } from "lucide-react"
import { cn } from "@/lib/utils"

const NAV = [
  { href: "/worker/dashboard",    label: "Dashboard",   icon: LayoutDashboard },
  { href: "/worker/jobs",         label: "Jobs",        icon: ClipboardList   },
  { href: "/worker/availability", label: "Availability",icon: CalendarCheck   },
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  active ? "text-white" : "hover:bg-[var(--color-neutral-100)]"
                )}
                style={{
